...
import com.github.dawndev.wms.system.dao.UserRoleMapper;
import com.github.dawndev.wms.system.domain.User;
import com.github.dawndev.wms.system.domain.UserRole;
import com.github.dawndev.wms.system.manager.UserManager;
import com.github.dawndev.wms.system.service.UserConfigService;
import com.github.dawndev.wms.system.service.UserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 注册用户
     *
     * @param studentInfo 用户
     */
    @Override
    public void registUser(StudentInfo studentInfo) throws Exception {
        User user = new User();
        user.setPassword(MD5Util.encrypt(studentInfo.getCode(), "1234qwer"));
        user.setUsername(studentInfo.getCode());
        user.setCreateTime(new Date());
        user.setStatus(User.STATUS_VALID);
        user.setSsex(User.SEX_UNKNOW);
        user.setAvatar(User.DEFAULT_AVATAR);
